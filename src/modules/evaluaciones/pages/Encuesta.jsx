...
const TABS = [
  { id: 'clima_aula', etiqueta: 'Clima de Aula', instrumento: INSTRUMENTO_CLIMA_AULA },
  { id: 'gshs', etiqueta: 'GSHS', instrumento: INSTRUMENTO_GSHS },
];
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="p-6 md:p-10 max-w-3xl mx-auto">
        ...
        <VistaInstrumentoSoloLectura instrumento={tab.instrumento} />
      </div>
    </div>
  );
}