...
export const PsicologoModal = ({ isOpen, onClose, onSave, psicologoEditado }) => {
  ...
  return (
    <PsicologoModalContenido
      onClose={onClose}
      onSave={onSave}
      psicologoEditado={psicologoEditado}
    />
  );
};

function PsicologoModalContenido({ onClose, onSave, psicologoEditado }) {
  const enEdicion = Boolean(psicologoEditado);
              ...
              >
                {loading ? (
                  <span className="flex items-center">
                    ...
                    {enEdicion ? 'Guardando...' : 'Creando...'}
                  </span>
                ) : (
                  enEdicion ? 'Guardar' : 'Crear cuenta'
                )}
              </button>
            </div>
          </form>
